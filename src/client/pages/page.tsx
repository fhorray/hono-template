        ...
        <main className="space-y-8">
          <section className="bg-muted/30 rounded-2xl p-8 border border-border/50 text-center font-sans">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <Button
                size="lg"
                className="shadow-lg shadow-primary/20 font-sans"
              >
                Regular Button
              </Button>
              ...
              <Sheet>
                ...
                <SheetContent side="right">
                  <SheetHeader>
                    ...
                    <SheetDescription>
                      This component now lives in <strong>ui/sheet.tsx</strong>{' '}
                      and uses the native checkbox hack for state management.
                    </SheetDescription>
                  </SheetHeader>

                  <div className="p-6 space-y-6 text-foreground font-sans">
                    <section className="space-y-3">
                      <h4 className="font-semibold text-primary uppercase text-xs tracking-widest font-sans">
                        Architecture
                      </h4>
                      <p className="text-sm text-muted-foreground leading-relaxed font-sans">
                        By moving the logic to the component folder, we keep the
                        pages clean and reusable.
                      </p>
                    </section>

                    <div className="grid grid-cols-2 gap-3">
                      <div className="p-4 bg-muted/50 rounded-xl border border-border/50 text-center">
                        <span className="block text-2xl font-bold font-sans">
                          100%
                        </span>
          ...
          <nav className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            >
              ...
              <span className="text-sm text-muted-foreground mt-1 font-sans">
                Check dynamic routing with parameters.
              </span>
            </a>
            <a
              href="/api/hello"
