...
function SheetHeader({ className, ...props }: JSX.IntrinsicElements['div']) {
  return (
    <div
...
function SheetFooter({ className, ...props }: JSX.IntrinsicElements['div']) {
  return (
    <div
...
function SheetTitle({ className, ...props }: JSX.IntrinsicElements['h3']) {
  return (
    <h3
...
function SheetDescription({ className, ...props }: JSX.IntrinsicElements['p']) {
  return (
    <p
